    ...
    **************************************************************************/
    ...
    void VT::execute(void *param)
    {
        ...
        switch(param_p->pageIndex)
        {
            ...
            VTApplication *applicationPage;
            applicationPage = qobject_cast<VTApplication *>(param_p->executor);
    ...
    void VT::switchFuncPageSlot(int pageIndex)
    {
        if(pageIndex >= FUNC_PAGE_MIN && pageIndex <= FUNC_PAGE_MAX)
        {
         ...
         case APPLICATION_PAGE:
                    m_FunctionPageHash[pageIndex] = new VTApplication;
                    break;
    ...
    m_ButtonGroup_p->addButton(btn_general,GENERAL_PAGE);m_ButtonGroup_p->addButton(btn_application,APPLICATION_PAGE);
