    ...
    **************************************************************************/
    ...
    ECVT::ECVT(QWidget *parent):Widget(parent)
    {
        ...
        connecst (m_ECVTCategory, SIGNAL (closeWindowSignal()), this, SLOT (closeWindowSlot()));
...
");
    ...
    void ECVT::execute(void * param)
    {
        ...
        switch(param_p->pageIndex)
        {
            ...
            case ECVT_MAINTENANCE_PAGE:
            ECVTMaintenance * maintenancePage;
            maintenancePage = qobject_cast<ECVTMaintenance *>(param_p->executor);
        ...
        default:
                ...
                else
                {
                    QMessageBox::warning(this, 
                        QString("Switch Page"), 
                        QString("ECVT create function page(EC) failed!").arg(pageIndex));
                    return;
                }
            }
    ...
    m_ButtonGroup_p->addButton(btn_maintenance,ECVT_MAINTENANCE_PAGE);m_ButtonGroup_p->addButton(btn_general,ECVT_GENERAL_PAGE);
